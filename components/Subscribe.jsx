  ...
  return (
    <section id="subscribe" className="bg-sky-50 py-20">
      <div className="container mx-auto px-4 text-center">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-medium font-spline text-[#2B383D] mb-2">Subscribe to Our Newsletter</h2>
          <p className="text-lg mb-12 font-spline text-gray-700">Get new offers and updates directly in your inbox.</p>
        </motion.div>
        <motion.form
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}

...
import { FaFacebookF, FaYoutube, FaTwitter, FaGoogle, FaInstagram, FaLinkedinIn, FaGithub, FaWindowClose } from 'react-icons/fa';
    ...
    <footer className="bg-neutral-900 py-5 text-white">
      <div className="container mx-auto px-4 text-center">
        <div className="flex justify-center space-x-4 mb-4">
          ...
          <a href="mailto:smartgrader02@gmail.com" className="text-white hover:text-sky-500 transition duration-300">
            <SiGmail />
          </a>
